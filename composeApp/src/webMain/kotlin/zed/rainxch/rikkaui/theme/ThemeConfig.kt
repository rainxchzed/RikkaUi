 ...
 *
 * ```
 * val colors = resolvePalette("Zinc", isDark = true)
 * ```
 */
fun resolvePalette(
    name: String,
 ...
 *
 * ```
 * val accented = resolveAccent(baseColors, "Blue", isDark = true)
 * ```
 */
fun resolveAccent(
    base: RikkaColors,
 ...
 * Used by the theme section to show colored dots on accent buttons.
 */
